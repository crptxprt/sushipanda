...
const pages = [
  {
    path: '/',
    title: 'Sushi ketering u Kragujevcu za firme i proslave | Sushi Panda',
    description: 'Premium sushi ketering za firme, proslave, slave i događaje u Kragujevcu i centralnoj Srbiji. Live sushi chef, postavka i ponuda po meri.',
    h1: 'Sushi ketering za firme, proslave i događaje u Kragujevcu',
  ...
  },
  {
    ...
    title: 'Sushi catering za proslave u Kragujevcu | Sushi Panda',
    description: 'Sushi catering za rođendane i privatne proslave u Kragujevcu. Sveža priprema, elegantna postavka i ponuda po meri.',
    h1: 'Sushi catering za privatne proslave',
    text: 'Organizujemo sushi catering za rođendane, godišnjice i privatne proslave u Kragujevcu i centralnoj Srbiji.',
  },
  {
    path: '/ketering-slave',
    title: 'Sushi ketering za slave u Kragujevcu | Sushi Panda',
    description: 'Premium sushi ketering za slave u Kragujevcu: pažljivo pripremljen meni, postavka i dostava za vaše goste.',
  ...
  },
  {
    ...
    description: 'Atraktivan sushi catering za devojačko i momačko veče u Kragujevcu. Premium serving i ponuda po meri.',
  ...
  },
  {
    ...
    title: 'Ketering za firme u Kragujevcu | Sushi Panda',
    description: 'Premium sushi catering za firme i poslovne događaje u Kragujevcu. Profesionalna usluga, postavka i ponuda po meri.',
  ...
  {
    path: '/sushi-chef',
    title: 'Sushi chef za događaje u Kragujevcu | Sushi Panda',
    description: 'Iznajmite sushi chef-a za događaj u Kragujevcu. Sveži sastojci, live priprema i interaktivno iskustvo za goste.',
  ...
  },
  {
    ...
    description: 'Pogledajte galeriju Sushi Panda cateringa: premium sushi postavke, live chef i događaji u Kragujevcu.',
  ...
  {
    path: '/o-nama',
    title: 'O Sushi Panda Catering timu | Kragujevac',
    description: 'Upoznajte tim Sushi Panda Catering-a iz Kragujevca — kuvare i sushi majstore za proslave i poslovne događaje.',
  ...
  {
    path: '/kontakt',
    title: 'Kontakt za sushi catering u Kragujevcu | Sushi Panda',
    description: 'Pošaljite upit za premium sushi catering, proslavu ili poslovni događaj u Kragujevcu i centralnoj Srbiji.',
...
function seoMarkup(page) {
  ...
  const jsonLd = JSON.stringify({
    ...
    '@graph': [
      ...
      { '@type': 'Service', '@id': `${canonical}#service`, name: 'Sushi ketering', serviceType: 'Sushi catering', provider: { '@id': `${siteUrl}/#organization` }, areaServed: [{ '@type': 'City', name: 'Kragujevac' }, { '@type': 'AdministrativeArea', name: 'Centralna Srbija' }] },
    ],
  }).replaceAll('<', '\\u003c');
